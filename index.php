...
<script>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(https://assets.bonappetit.com/photos/5c366551f212512d0e6cefd0/16:9/w_2240,c_limit/Basically-Coffee-0219-03.jpg);">
				...
				<div class="item-slick1" style="background-image: url(https://i0.wp.com/www.mobileworldlive.com/wp-content/uploads/2016/07/smartphones-e1613994380151.jpg?fit=500%2C332&ssl=1);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url(https://bachhubrilliance.com/wp-content/uploads/2024/02/Bachhu-Brilliance.webp);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rotateInDownLeft" data-delay="0">
								<span class="ltext-101 cl2 respon2">
							...
							<div class="layer-slick1 animated visible-false" data-appear="rotateInUpRight" data-delay="800">
								<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1">
									Its never too late to buy a diamond
								</h2>
							</div>
								
							<div class="layer-slick1 animated visible-false" data-appear="rotateIn" data-delay="1600">
								<a href="http://divyam-cmpe272.infinityfreeapp.com/CMPE272Project/index.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Explore
								</a>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-md-6 col-md-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="https://i0.wp.com/www.mobileworldlive.com/wp-content/uploads/2016/07/smartphones-e1613994380151.jpg?fit=500%2C332&ssl=1" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-md-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="https://bachhubrilliance.com/wp-content/uploads/2024/02/Bachhu-Brilliance.webp" alt="IMG-BANNER">

						<a href="http://divyam-cmpe272.infinityfreeapp.com/CMPE272Project/index.php" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									Diamond Store
								</span>
			...
			<div class="row">
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<ul>
						...
						<li class="p-b-10">
							<a href="http://divyam-cmpe272.infinityfreeapp.com/CMPE272Project/index.php" class="stext-107 cl7 hov-cl1 trans-04">
								Diamond Store
							</a>
						</li>
					</ul>
