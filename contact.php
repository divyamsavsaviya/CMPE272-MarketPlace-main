        ...
        <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
          <form id="SendEmail" method="POST" action="./contact.php">
            ...
            <select class="form-control" id="sel1" name="StoreEmailAddress" required>
              ...
              <option value="Games">Diamond Store</option>
              <option value="Homes">OLX</option>
              <option value="Bikes">Sparten Book store</option>
              <option value="Books">Coffee Beans Store</option>
            </select><br>
          ...
          if (isset($_POST['submit'])) {
            switch ($_POST['StoreEmailAddress']) {
              case "Homes":
                $storeAddress = "divyavarshini.suravaram@sjsu.edu";
                break;

              case "Games":
                $storeAddress = "vamshiraj.nagula@sjsu.edu";
                break;

              case "Bikes":
                $storeAddress = "joshita.atmakuri@sjsu.edu";
                break;

              case "Books":
                $storeAddress = "divyamashokbhai.savsaviya@sjsu.edu";
                break;
            }

            echo "Thanks for your message! We will get back to you soon!";
